...
import UseContext from "./starts/useContext.start";
import UseContextEnd from "./ends/useContext.end";
...
root.render(
  <BrowserRouter>
    <Routes>
      ...
      <Route path="start/useContext" element={<UseContext />} />
      <Route path="end/useContext" element={<UseContextEnd />} />
    </Routes>
  </BrowserRouter>
);
